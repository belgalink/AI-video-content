# Niche 40 — Beveiligingsinstallatie (camera & alarm)
...
- `camerabewaking alarmsystemen installateur Vlaanderen`
- `beveiligingsfirma B2B België`

**Indicatieve NACEBEL-code(s):** 80.20 / 43.21
