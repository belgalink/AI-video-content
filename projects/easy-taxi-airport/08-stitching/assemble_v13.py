...
TMP="/tmp/asm_v13"; os.makedirs(TMP,exist_ok=True)
...
# ============ VIDEO ============
# Only scene 2 changes from v12: regenerated without video_references (which had
# reproduced a literal handshake grip at the suitcase handle) -- this version was
# prompted explicitly for a handle-only handover, hands not clasping each other.
# It kept the corrected plate on its own, no patch needed.
SCENES=[
...
# ============ AUDIO: same as v12 (softer synthesized bed, single crossfade, dialogue mix) ============
...
out=f"{OUT}/easy-taxi-belgium-ad-9x16-v13.mp4"
...
print("FINAL v13:",out,"dur",re.search(r"Duration: ([0-9:.]+)",d).group(1))
