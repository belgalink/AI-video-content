# Niche 34 — Industriële poorten & toegangstechniek
...
- `industriële poorten toegangstechniek Vlaanderen`
- `sectionaalpoorten bedrijf B2B België`

**Indicatieve NACEBEL-code(s):** 43.32 / 43.29
